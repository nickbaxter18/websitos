...
class ChangedSetting:
    ...
    def __init__(
        self, setting: SettingCodes | int, original_value: int | None, new_value: int
    ) -> None:
    ...
    def __repr__(self) -> str:
        return f"ChangedSetting(setting={self.setting!s}, original_value={self.original_value}, new_value={self.new_value})"
...
class Settings(MutableMapping[Union[SettingCodes, int], int]):
    ...
    def __init__(
        self, client: bool = True, initial_values: dict[SettingCodes, int] | None = None
    ) -> None:
