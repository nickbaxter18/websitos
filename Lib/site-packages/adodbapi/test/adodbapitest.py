...
from sqlalchemy import create_enginetestconfig as config  # run the configuration module. # will set sys.path to find correct version of adodbapi
import tryconnection  # in our code below, all our switches are from config.whatever

from sqlalchemy import create_engine
from sqlalchemy import create_engine.apibase as api
