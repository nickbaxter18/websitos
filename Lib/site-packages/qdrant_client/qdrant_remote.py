...
class QdrantRemote(QdrantBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if grpc_compression is not None and not isinstance(
    ...
    def _init_grpc_channel(self) -> None:
        if self._closed:
            raise RuntimeError(
                "Client was closed. Please create a new QdrantClient instance."
            )
    ...
    def search_batch(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            return [
                [GrpcToRest.convert_scored_point(hit) for hit in r.result]
                for r in grpc_res.result
            ]
        else:
            requests = [
                (
                    GrpcToRest.convert_search_points(r)
                    if isinstance(r, grpc.SearchPoints)
                    else r
                )
                for r in requests
            ]
    ...
    def search(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            if isinstance(
                with_payload, get_args_subscribed(models.WithPayloadInterface)
            ):
            ...
            if isinstance(
                shard_key_selector, get_args_subscribed(models.ShardKeySelector)
            ):
                shard_key_selector = RestToGrpc.convert_shard_key_selector(
                    shard_key_selector
                )
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            if isinstance(prefetch, list):
                prefetch = [
                    (
                        RestToGrpc.convert_prefetch_query(p)
                        if isinstance(p, models.Prefetch)
                        else p
                    )
                    for p in prefetch
                ]
    ...
    def query_batch_points(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            requests = [
                (
                    GrpcToRest.convert_query_points(r)
                    if isinstance(r, grpc.QueryPoints)
                    else r
                )
                for r in requests
            ]
    ...
    def search_matrix_pairs(
        ...
        **kwargs: Any,
        ...
        assert (
            search_matrix_result is not None
        ), "Search matrix pairs returned None result"
    ...
    def search_matrix_offsets(
        ...
        **kwargs: Any,
        ...
        assert (
            search_matrix_result is not None
        ), "Search matrix offsets returned None result"
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            http_res: list[list[models.ScoredPoint]] = (
                self.http.search_api.recommend_batch_points(
                    collection_name=collection_name,
                    consistency=consistency,
                    timeout=timeout,
                    recommend_request_batch=models.RecommendRequestBatch(
                        searches=requests
                    ),
                ).result
            )
    ...
    def recommend(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            positive_vectors = RestToGrpc.convert_recommend_examples_to_vectors(
                positive
            )
    ...
    def discover_batch(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            http_res: list[list[models.ScoredPoint]] = (
                self.http.search_api.discover_batch_points(
                    collection_name=collection_name,
                    discover_request_batch=models.DiscoverRequestBatch(
                        searches=requests
                    ),
                    consistency=consistency,
                    timeout=timeout,
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            if isinstance(points, models.Batch):
                vectors_batch: list[grpc.Vectors] = (
                    RestToGrpc.convert_batch_vector_struct(
    ...
    def delete_vectors(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            points_selector, opt_shard_key_selector = (
                self._try_argument_to_grpc_selector(points)
            )
    ...
    def retrieve(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            ids = [
                (
                    GrpcToRest.convert_point_id(idx)
                    if isinstance(idx, grpc.PointId)
                    else idx
                )
                for idx in ids
            ]
                ...
                points=grpc.PointsIdsList(
                    ids=[
                        (
                            RestToGrpc.convert_extended_point_id(idx)
                            if isinstance(
                                idx, get_args_subscribed(models.ExtendedPointId)
                            )
                            else idx
                        )
                        for idx in points
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            points_selector, opt_shard_key_selector = (
                self._try_argument_to_grpc_selector(points_selector)
            )
            shard_key_selector = shard_key_selector or opt_shard_key_selector
    ...
    def set_payload(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            _points, _filter = self._try_argument_to_rest_points_and_filter(points)
            result: Optional[types.UpdateResult] = (
                self.openapi_client.points_api.set_payload(
                    collection_name=collection_name,
                    wait=wait,
                    ordering=ordering,
    ...
    def delete_payload(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            _points, _filter = self._try_argument_to_rest_points_and_filter(points)
            result: Optional[types.UpdateResult] = (
                self.openapi_client.points_api.delete_payload(
                    collection_name=collection_name,
                    wait=wait,
                    ordering=ordering,
    ...
    def clear_payload(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            result: Optional[types.UpdateResult] = (
                self.openapi_client.points_api.clear_payload(
                    collection_name=collection_name,
                    wait=wait,
                    ordering=ordering,
                    points_selector=points_selector,
    ...
    def batch_update_points(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            update_operations = [
                RestToGrpc.convert_update_operation(operation)
    ...
    def get_collection_aliases(
        ...
        if self._prefer_grpc:
            ...
            return types.CollectionsAliasesResponse(
                aliases=[
                    GrpcToRest.convert_alias_description(description)
                    for description in response
                ]
            )

        result: Optional[types.CollectionsAliasesResponse] = (
            self.http.aliases_api.get_collection_aliases(
                collection_name=collection_name
            ).result
        )
    ...
    def get_collection(
        ...
        result: Optional[types.CollectionInfo] = (
            self.http.collections_api.get_collection(
                collection_name=collection_name
            ).result
        )
    ...
    def collection_exists(self, collection_name: str, **kwargs: Any) -> bool:
        ...
        result: Optional[models.CollectionExistence] = (
            self.http.collections_api.collection_exists(
                collection_name=collection_name
            ).result
        )
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            if isinstance(optimizers_config, models.OptimizersConfigDiff):
                optimizers_config = RestToGrpc.convert_optimizers_config_diff(
                    optimizers_config
                )

            if isinstance(collection_params, models.CollectionParamsDiff):
                collection_params = RestToGrpc.convert_collection_params_diff(
                    collection_params
                )
            ...
            if isinstance(strict_mode_config, models.StrictModeConfig):
                strict_mode_config = RestToGrpc.convert_strict_mode_config(
                    strict_mode_config
                )
        ...
        if isinstance(quantization_config, grpc.QuantizationConfigDiff):
            quantization_config = GrpcToRest.convert_quantization_config_diff(
                quantization_config
            )
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            if isinstance(
                ...
                quantization_config = RestToGrpc.convert_quantization_config(
                    quantization_config
                )
            ...
            return self.grpc_collections.Create(
                create_collection, timeout=self._timeout
            ).result
        ...
        if isinstance(quantization_config, grpc.QuantizationConfig):
            quantization_config = GrpcToRest.convert_quantization_config(
                quantization_config
            )
    ...
    def create_payload_index(
        ...
        **kwargs: Any,
        ...
        result: Optional[types.UpdateResult] = (
            self.openapi_client.indexes_api.create_field_index(
                collection_name=collection_name,
    ...
    def delete_payload_index(
        ...
        **kwargs: Any,
        ...
        result: Optional[types.UpdateResult] = (
            self.openapi_client.indexes_api.delete_field_index(
                collection_name=collection_name,
                field_name=field_name,
                wait=wait,
                ordering=ordering,
    ...
    def list_snapshots(
        ...
        if self._prefer_grpc:
            ...
            return [
                GrpcToRest.convert_snapshot_description(snapshot)
    ...
    def lock_storage(self, reason: str, **kwargs: Any) -> types.LocksOption:
        result: Optional[types.LocksOption] = (
            self.openapi_client.service_api.post_locks(
    ...
    def get_locks(self, **kwargs: Any) -> types.LocksOption:
        result: Optional[types.LocksOption] = (
            self.openapi_client.service_api.get_locks().result
        )
