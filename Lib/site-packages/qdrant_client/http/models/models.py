...
class AppBuildTelemetry(BaseModel):
    ...
    hnsw_global_config: Optional["HnswGlobalConfig"] = Field(
        default=None, description=""
    )
    system: Optional["RunningEnvironmentTelemetry"] = Field(
        default=None, description=""
    )
...
class BinaryQuantizationConfig(BaseModel, extra="forbid"):
    ...
    encoding: Optional["BinaryQuantizationEncoding"] = Field(
        default=None, description=""
    )
...
class BoolIndexParams(BaseModel, extra="forbid"):
    ...
    on_disk: Optional[bool] = Field(
        default=None, description="If true, store the index on disk. Default: false."
    )
...
class ClusterStatusOneOf(BaseModel):
    status: Literal["disabled",] = Field(..., description="")
...
class CollectionClusterInfo(BaseModel):
    ...
    shard_transfers: List["ShardTransferInfo"] = Field(
        ..., description="Shard transfers"
    )
    resharding_operations: Optional[List["ReshardingInfo"]] = Field(
        default=None, description="Resharding operations"
    )
...
class CollectionInfo(BaseModel):
    ...
    payload_schema: Dict[str, "PayloadIndexInfo"] = Field(
...
class CollectionParams(BaseModel):
    ...
    shard_number: Optional[int] = Field(
        default=1, description="Number of shards the collection has"
    )
    ...
    replication_factor: Optional[int] = Field(
        default=1, description="Number of replicas for each shard"
    )
...
class CollectionParamsDiff(BaseModel, extra="forbid"):
    replication_factor: Optional[int] = Field(
        default=None, description="Number of replicas for each shard"
    )
    write_consistency_factor: Optional[int] = Field(
        default=None,
...
class CollectionTelemetry(BaseModel):
    ...
    shard_clean_tasks: Optional[Dict[str, "ShardCleanStatusTelemetry"]] = Field(
        default=None, description=""
    )
...
class CollectionsTelemetry(BaseModel):
    ...
    collections: Optional[List["CollectionTelemetryEnum"]] = Field(
        default=None, description=""
    )
...
class ConsensusThreadStatusOneOf(BaseModel):
    consensus_thread_status: Literal["working",] = Field(..., description="")
    last_update: Union[datetime, date] = Field(..., description="")


class ConsensusThreadStatusOneOf1(BaseModel):
    consensus_thread_status: Literal["stopped",] = Field(..., description="")


class ConsensusThreadStatusOneOf2(BaseModel):
    consensus_thread_status: Literal["stopped_with_err",] = Field(..., description="")
...
class CountRequest(BaseModel, extra="forbid"):
    ...
    filter: Optional["Filter"] = Field(
        default=None, description="Look only for points which satisfies this conditions"
    )
...
class CreateCollection(BaseModel, extra="forbid"):
    ...
    init_from: Optional["InitFrom"] = Field(
        default=None,
        description="Specify other collection to copy data from.  Deprecated since Qdrant 1.15.0.",
    )
    quantization_config: Optional["QuantizationConfig"] = Field(
        default=None,
    ...
    strict_mode_config: Optional["StrictModeConfig"] = Field(
        default=None, description="Strict-mode config."
    )
...
class DatetimeRange(BaseModel, extra="forbid"):
    ...
    lt: Optional[Union[datetime, date]] = Field(
        default=None, description="point.key &lt; range.lt"
    )
    gt: Optional[Union[datetime, date]] = Field(
        default=None, description="point.key &gt; range.gt"
    )
    gte: Optional[Union[datetime, date]] = Field(
        default=None, description="point.key &gt;= range.gte"
    )
    lte: Optional[Union[datetime, date]] = Field(
...
class DiscoverRequest(BaseModel, extra="forbid"):
    ...
    params: Optional["SearchParams"] = Field(
        default=None, description="Additional search params"
    )
...
class ErrorResponse(BaseModel):
    time: Optional[float] = Field(
        default=None, description="Time spent to process this request"
    )
...
class ErrorResponseStatus(BaseModel):
    error: Optional[str] = Field(
        default=None, description="Description of the occurred error."
    )
...
class FacetRequest(BaseModel, extra="forbid"):
    ...
    limit: Optional[int] = Field(
        default=None, description="Max number of hits to return. Default is 10."
    )
    filter: Optional["Filter"] = Field(
        default=None,
...
class FeatureFlags(BaseModel):
    ...
    incremental_hnsw_building: Optional[bool] = Field(
        default=True,
        description="Use incremental HNSW building.  Enabled by default in Qdrant 1.14.1.",
    )
...
class FieldCondition(BaseModel, extra="forbid"):
    ...
    range: Optional["RangeInterface"] = Field(
    ...
    geo_radius: Optional["GeoRadius"] = Field(
        default=None, description="Check if geo point is within a given radius"
    )
    geo_polygon: Optional["GeoPolygon"] = Field(
        default=None, description="Check if geo point is within a given polygon"
    )
    values_count: Optional["ValuesCount"] = Field(
        default=None, description="Check number of values of the field"
    )
...
class Filter(BaseModel, extra="forbid"):
    ...
    must: Optional[Union[List["Condition"], "Condition"]] = Field(
...
class HasIdCondition(BaseModel, extra="forbid"):
    ...
    has_id: List["ExtendedPointId"] = Field(
...
class InlineResponse20025(BaseModel):
    ...
    status: Optional[str] = Field(default=None, description="")
    result: Optional["SearchMatrixOffsetsResponse"] = Field(
        default=None, description=""
    )
...
class IntegerIndexParams(BaseModel, extra="forbid"):
    ...
    lookup: Optional[bool] = Field(
        default=None, description="If true - support direct lookups. Default is true."
    )
    range: Optional[bool] = Field(
        default=None, description="If true - support ranges filters. Default is true."
    )
    is_principal: Optional[bool] = Field(
        default=None,
...
class LocalShardInfo(BaseModel):
    ...
    shard_key: Optional["ShardKey"] = Field(
        default=None, description="User-defined sharding key"
    )
...
class LocalShardTelemetry(BaseModel):
    ...
    total_optimized_points: int = Field(
...
class MessageSendErrors(BaseModel):
    ...
    latest_error: Optional[str] = Field(
        default=None, description="Message send failures for a particular peer"
    )
...
class OperationDurationStatistics(BaseModel):
    ...
    last_responded: Optional[Union[datetime, date]] = Field(
        default=None, description=""
    )
...
class OptimizersConfigDiff(BaseModel, extra="forbid"):
    ...
    flush_interval_sec: Optional[int] = Field(
        default=None, description="Minimum interval between forced flushes."
    )
...
class PayloadStorageTypeOneOf(BaseModel):
    type: Literal["in_memory",] = Field(..., description="")


class PayloadStorageTypeOneOf1(BaseModel):
    type: Literal["on_disk",] = Field(..., description="")


class PayloadStorageTypeOneOf2(BaseModel):
    type: Literal["mmap",] = Field(..., description="")


class PayloadStorageTypeOneOf3(BaseModel):
    type: Literal["in_ram_mmap",] = Field(..., description="")
...
class PointGroup(BaseModel):
    hits: List["ScoredPoint"] = Field(
        ..., description="Scored points that have the same value of the group_by key"
    )
    id: "GroupId" = Field(..., description="")
    lookup: Optional["Record"] = Field(
        default=None, description="Record that has been looked up using the group id"
    )
...
class PointStruct(BaseModel, extra="forbid"):
    ...
    payload: Optional["Payload"] = Field(
        default=None, description="Payload values (optional)"
    )
...
class Prefetch(BaseModel, extra="forbid"):
    ...
    params: Optional["SearchParams"] = Field(
        default=None, description="Search params for when there is no prefetch"
    )
    ...
    limit: Optional[int] = Field(
        default=None, description="Max number of points to return. Default is 10."
    )
    lookup_from: Optional["LookupLocation"] = Field(
        default=None,
...
class QueryGroupsRequest(BaseModel, extra="forbid"):
    ...
    limit: Optional[int] = Field(
        default=None, description="Maximum amount of groups to return. Default is 10."
    )
...
class RaftInfo(BaseModel):
    ...
    leader: Optional[int] = Field(
        default=None, description="Leader of the current term"
    )
    role: Optional["StateRole"] = Field(
        default=None, description="Role of this peer in the current term"
    )
...
class RecommendGroupsRequest(BaseModel, extra="forbid"):
    ...
    positive: Optional[List["RecommendExample"]] = Field(
        default=[], description="Look for vectors closest to those"
    )
    negative: Optional[List["RecommendExample"]] = Field(
        default=[], description="Try to avoid vectors like this"
    )
...
class Record(BaseModel):
    ...
    payload: Optional["Payload"] = Field(
        default=None, description="Payload - values assigned to the point"
    )
    vector: Optional["VectorStructOutput"] = Field(
...
class RunningEnvironmentTelemetry(BaseModel):
    ...
    gpu_devices: Optional[List["GpuDeviceTelemetry"]] = Field(
        default=None, description=""
    )
...
class ScoredPoint(BaseModel):
    ...
    shard_key: Optional["ShardKey"] = Field(default=None, description="Shard Key")
    order_value: Optional["OrderValue"] = Field(
        default=None, description="Order-by value"
    )
...
class ScrollRequest(BaseModel, extra="forbid"):
    ...
    offset: Optional["ExtendedPointId"] = Field(
        default=None, description="Start ID to read points from."
    )
    ...
    order_by: Optional["OrderByInterface"] = Field(
        default=None, description="Order the records by a payload field."
    )
...
class SearchMatrixPairsResponse(BaseModel):
    pairs: List["SearchMatrixPair"] = Field(
...
class SearchParams(BaseModel, extra="forbid"):
    ...
    quantization: Optional["QuantizationSearchParams"] = Field(
        default=None, description="Quantization params"
    )
...
class SegmentConfig(BaseModel):
    vector_data: Optional[Dict[str, "VectorDataConfig"]] = Field(
        default={}, description=""
    )
    sparse_vector_data: Optional[Dict[str, "SparseVectorDataConfig"]] = Field(
        default=None, description=""
    )
...
class SegmentTelemetry(BaseModel):
    ...
    vector_index_searches: List["VectorIndexSearchesTelemetry"] = Field(
        ..., description=""
    )
...
class StrictModeConfig(BaseModel, extra="forbid"):
    ...
    max_timeout: Optional[int] = Field(
        default=None, description="Max allowed `timeout` parameter."
    )
    ...
    search_max_hnsw_ef: Optional[int] = Field(
        default=None, description="Max HNSW value allowed in search parameters."
    )
    search_allow_exact: Optional[bool] = Field(
        default=None, description="Whether exact search is allowed or not."
    )
    search_max_oversampling: Optional[float] = Field(
        default=None, description="Max oversampling value allowed in search."
    )
    upsert_max_batchsize: Optional[int] = Field(
        default=None, description="Max batchsize when upserting"
    )
    ...
    max_points_count: Optional[int] = Field(
        default=None, description="Max number of points estimated in a collection"
    )
    filter_max_conditions: Optional[int] = Field(
        default=None, description="Max conditions a filter can have."
    )
...
class StrictModeMultivector(BaseModel, extra="forbid"):
    max_vectors: Optional[int] = Field(
        default=None, description="Max number of vectors in a multivector"
    )
...
class StrictModeSparse(BaseModel, extra="forbid"):
    max_length: Optional[int] = Field(
        default=None, description="Max length of sparse vector"
    )
...
class TextIndexParams(BaseModel, extra="forbid"):
    ...
    min_token_len: Optional[int] = Field(
        default=None, description="Minimum characters to be tokenized."
    )
    max_token_len: Optional[int] = Field(
        default=None, description="Maximum characters to be tokenized."
    )
    lowercase: Optional[bool] = Field(
        default=None, description="If true, lowercase all tokens. Default: true."
    )
...
class TrackerTelemetry(BaseModel):
    ...
    start_at: Union[datetime, date] = Field(
        ..., description="Start time of the optimizer"
    )
    end_at: Optional[Union[datetime, date]] = Field(
        default=None, description="End time of the optimizer"
    )
...
class UpdateResult(BaseModel):
    operation_id: Optional[int] = Field(
        default=None, description="Sequential number of the operation"
    )
...
class UuidIndexParams(BaseModel, extra="forbid"):
    ...
    is_tenant: Optional[bool] = Field(
        default=None, description="If true - used for tenant optimization."
    )
    on_disk: Optional[bool] = Field(
        default=None, description="If true, store the index on disk. Default: false."
    )
...
class ValuesCount(BaseModel, extra="forbid"):
    ...
    lt: Optional[int] = Field(
        default=None, description="point.key.length() &lt; values_count.lt"
    )
    gt: Optional[int] = Field(
        default=None, description="point.key.length() &gt; values_count.gt"
    )
    gte: Optional[int] = Field(
        default=None, description="point.key.length() &gt;= values_count.gte"
    )
    lte: Optional[int] = Field(
        default=None, description="point.key.length() &lt;= values_count.lte"
    )
...
class WalConfigDiff(BaseModel, extra="forbid"):
    wal_capacity_mb: Optional[int] = Field(
        default=None, description="Size of a single WAL segment in MB"
    )
...
ShardSnapshotLocation = Union[StrictStr,]
