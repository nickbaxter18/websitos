...
def calculate_multi_distance_core(
    ...
    def euclidean(
        q: types.NumpyArray, m: types.NumpyArray, *_: Any
    ) -> types.NumpyArray:
...
def calculate_multi_discovery_scores(
    ...
    distances_to_target = calculate_multi_distance_core(
        query.target, matrices, distance_type
    )
