...
@pytest.mark.parametrize(
    ...
    [
        ...
        models.RecommendQuery(
            recommend=models.RecommendInput(positive=[1], negative=[1])
        ),
        ...
        models.ContextQuery(
            context=[models.ContextPair(**{"positive": 1, "negative": 1})]
        ),
        models.OrderByQuery(
            order_by=models.OrderBy(key="price", direction=models.Direction.ASC)
        ),
    ...
    [
        ...
        (
            ...
            models.LookupLocation(
                collection="collection_multiple_vectors", vector="colbert"
            ),
        ...
        (
            None,
            models.LookupLocation(
                collection="collection_multiple_vectors", vector="sparse"
            ),
