CACHE_STR_PATH = {
    ...
    "DiscoverQuery": [
        "discover.context.negative",
        "discover.context.positive",
        "discover.target",
    ],
    "DiscoverRequest": [],
...
DEFS = {
    ...
    "DatetimeExpression": {
        "additionalProperties": False,
        "properties": {
            "datetime": {"description": "", "title": "Datetime", "type": "string"}
        },
        "required": ["datetime"],
    ...
    "ExpDecayExpression": {
        "additionalProperties": False,
        "properties": {
            "exp_decay": {"$ref": "#/$defs/DecayParamsExpression", "description": ""}
        },
        "required": ["exp_decay"],
    ...
    "GeoDistance": {
        "additionalProperties": False,
        "properties": {
            "geo_distance": {"$ref": "#/$defs/GeoDistanceParams", "description": ""}
        },
    ...
    "LinDecayExpression": {
        "additionalProperties": False,
        "properties": {
            "lin_decay": {"$ref": "#/$defs/DecayParamsExpression", "description": ""}
        },
        "required": ["lin_decay"],
    ...
    "BinaryQuantizationConfig": {
        ...
        "properties": {
            ...
            "encoding": {
                "anyOf": [
                    {"$ref": "#/$defs/BinaryQuantizationEncoding"},
                    {"type": "null"},
                ],
                "default": None,
                "description": "",
            ...
            "query_encoding": {
                "anyOf": [
                    {"$ref": "#/$defs/BinaryQuantizationQueryEncoding"},
                    {"type": "null"},
                ],
                "default": None,
    ...
    "CreateAliasOperation": {
        "additionalProperties": False,
        "properties": {
            "create_alias": {"$ref": "#/$defs/CreateAlias", "description": ""}
        },
    ...
    "BinaryQuantization": {
        "additionalProperties": False,
        "properties": {
            "binary": {"$ref": "#/$defs/BinaryQuantizationConfig", "description": ""}
        },
        "required": ["binary"],
    ...
    "MultiVectorConfig": {
        "additionalProperties": False,
        "properties": {
            "comparator": {"$ref": "#/$defs/MultiVectorComparator", "description": ""}
        },
        "required": ["comparator"],
    ...
    "ScalarQuantization": {
        "additionalProperties": False,
        "properties": {
            "scalar": {"$ref": "#/$defs/ScalarQuantizationConfig", "description": ""}
        },
        "required": ["scalar"],
                ...
                "anyOf": [
                    {
                        "additionalProperties": {
                            "$ref": "#/$defs/StrictModeMultivector"
                        },
                        "type": "object",
                    },
                    {"type": "null"},
    ...
    "SearchParams": {
        ...
        "properties": {
            ...
            "quantization": {
                "anyOf": [
                    {"$ref": "#/$defs/QuantizationSearchParams"},
                    {"type": "null"},
                ],
                "default": None,
    ...
    "DiscoverQuery": {
        "additionalProperties": False,
        "properties": {
            "discover": {"$ref": "#/$defs/DiscoverInput", "description": ""}
        },
        "required": ["discover"],
        "title": "DiscoverQuery",
        "type": "object",
    ...
    "RecommendQuery": {
        "additionalProperties": False,
        "properties": {
            "recommend": {"$ref": "#/$defs/RecommendInput", "description": ""}
        },
        "required": ["recommend"],
    ...
    "ClearPayloadOperation": {
        ...
        "properties": {
            "clear_payload": {
                "anyOf": [
                    {"$ref": "#/$defs/PointIdsList"},
                    {"$ref": "#/$defs/FilterSelector"},
                ],
                "description": "",
                "title": "Clear Payload",
            }
    ...
    "DeletePayloadOperation": {
        "additionalProperties": False,
        "properties": {
            "delete_payload": {"$ref": "#/$defs/DeletePayload", "description": ""}
        },
    ...
    "DeleteVectorsOperation": {
        "additionalProperties": False,
        "properties": {
            "delete_vectors": {"$ref": "#/$defs/DeleteVectors", "description": ""}
        },
    ...
    "OverwritePayloadOperation": {
        "additionalProperties": False,
        "properties": {
            "overwrite_payload": {"$ref": "#/$defs/SetPayload", "description": ""}
        },
    ...
    "SetPayloadOperation": {
        "additionalProperties": False,
        "properties": {
            "set_payload": {"$ref": "#/$defs/SetPayload", "description": ""}
        },
    ...
    "UpdateVectorsOperation": {
        "additionalProperties": False,
        "properties": {
            "update_vectors": {"$ref": "#/$defs/UpdateVectors", "description": ""}
        },
