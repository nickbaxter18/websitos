...
class Embedder:
    def __init__(self, threads: Optional[int] = None, **kwargs: Any) -> None:
        self.embedding_models: dict[str, list[ModelInstance[TextEmbedding]]] = (
            defaultdict(list)
        )
        self.sparse_embedding_models: dict[
            str, list[ModelInstance[SparseTextEmbedding]]
        ] = defaultdict(list)
        self.late_interaction_embedding_models: dict[
            str, list[ModelInstance[LateInteractionTextEmbedding]]
        ] = defaultdict(list)
        self.image_embedding_models: dict[str, list[ModelInstance[ImageEmbedding]]] = (
            defaultdict(list)
        )
    ...
    def get_or_init_late_interaction_multimodal_model(
        ...
        **kwargs: Any,
        ...
        model_instance: ModelInstance[LateInteractionMultimodalEmbedding] = (
            ModelInstance(model=model, options=options)
        )
        self.late_interaction_multimodal_embedding_models[model_name].append(
            model_instance
        )
        return model
    ...
    def get_or_init_image_model(
        ...
        **kwargs: Any,
        ...
        model_instance: ModelInstance[ImageEmbedding] = ModelInstance(
            model=model, options=options
        )
    ...
    def embed(
        ...
        if texts is not None:
            ...
            elif FastEmbedMisc.is_supported_late_interaction_multimodal_model(
                model_name
            ):
            ...
            if FastEmbedMisc.is_supported_image_model(model_name):
                embeddings = self._embed_dense_image(
    ...
    def _embed_dense_text(
        ...
        embedding_model_inst = self.get_or_init_model(
