...
class AsyncQdrantRemote(AsyncQdrantBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if grpc_compression is not None and (
            not isinstance(grpc_compression, Compression)
        ):
            raise TypeError(
        ...
        if self._prefer_grpc:
            ...
            return (
                await self.grpc_collections.UpdateAliases(
                    grpc.ChangeAliases(
                        timeout=timeout, actions=change_aliases_operation
                    ),
                    timeout=timeout if timeout is not None else self._timeout,
                )
            ).result
    ...
    async def get_collection_aliases(
        ...
        result: Optional[types.CollectionsAliasesResponse] = (
            await self.http.aliases_api.get_collection_aliases(
                collection_name=collection_name
            )
        ).result
    ...
    async def get_collection(
        ...
        result: Optional[types.CollectionInfo] = (
            await self.http.collections_api.get_collection(
                collection_name=collection_name
            )
        ).result
    ...
    async def collection_exists(self, collection_name: str, **kwargs: Any) -> bool:
        ...
        result: Optional[models.CollectionExistence] = (
            await self.http.collections_api.collection_exists(
                collection_name=collection_name
            )
        ).result
    ...
    async def delete_collection(
        ...
        result: Optional[bool] = (
            await self.http.collections_api.delete_collection(
    ...
    async def create_collection(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            return (
                await self.grpc_collections.Create(
    ...
    async def create_payload_index(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            return GrpcToRest.convert_update_result(
                (
                    await self.grpc_points.CreateFieldIndex(
    ...
    async def delete_payload_index(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            return GrpcToRest.convert_update_result(
                (
                    await self.grpc_points.DeleteFieldIndex(
                        request, timeout=self._timeout
                    )
                ).result
            )
    ...
    async def list_snapshots(
        ...
        snapshots = (
            await self.openapi_client.snapshots_api.list_snapshots(
                collection_name=collection_name
            )
        ).result
    ...
    async def list_full_snapshots(
        ...
        snapshots = (
            await self.openapi_client.snapshots_api.list_full_snapshots()
        ).result
    ...
    async def create_full_snapshot(
        ...
        return (
            await self.openapi_client.snapshots_api.create_full_snapshot(wait=wait)
        ).result
