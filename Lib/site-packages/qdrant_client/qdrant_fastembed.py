...
class QdrantFastembedMixin(QdrantBase):
    ...
    @classmethod
    def list_late_interaction_text_models(
        cls,
    ...
    @classmethod
    def list_late_interaction_multimodal_models(
        cls,
    ) -> dict[str, tuple[int, models.Distance]]:
    ...
    def _embed_documents(
        ...
        if embed_type == "passage":
            ...
            vectors_iter = (
                list(embedding_model.query_embed(query=query))[0]
                for query in documents_a
            )
    ...
    def query(
        ...
        **kwargs: Any,
        ...
        sparse_vector = list(sparse_embedding_model_inst.query_embed(query=query_text))[
            0
        ]
        ...
        return self._scored_points_to_query_responses(
            reciprocal_rank_fusion(
                [dense_request_response, sparse_request_response], limit=limit
            )
        )
    ...
    def query_batch(
        ...
        **kwargs: Any,
        ...
        sparse_query_vectors = [
            ...
            for sparse_vector in sparse_embedding_model_inst.embed(
        ...
        responses = [
            ...
            for dense_response, sparse_response in zip(
                dense_responses, sparse_responses
            )
        ]

        return [
            self._scored_points_to_query_responses(response) for response in responses
        ]
