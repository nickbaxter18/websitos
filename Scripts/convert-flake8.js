...
// First, attempt to parse Flake8 structured output (if it exists)
// Flake8 by default writes to plain text, but we capture output file.
// We'll just hand logs to universal parser for consistency.
